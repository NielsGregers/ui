...
component: true
radix:
  link: https://www.radix-ui.com/shadcn/docs/primitives/components/dropdown-menu
  api: https://www.radix-ui.com/shadcn/docs/primitives/components/dropdown-menu#api-reference
---

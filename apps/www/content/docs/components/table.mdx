...
See the [Data Table](/shadcn/docs/components/data-table) documentation for more information.

You can also see an example of a data table in the [Tasks](/shadcn/examples/tasks) demo.

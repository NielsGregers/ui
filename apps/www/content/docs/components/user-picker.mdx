---
title: User Picker
description: A button that opens a dialog on click. The button will either show the avatar and name of the current user. I clicked, a dialog overlays the entire screen and shows a Command List with the ability to search Office Graph
featured: true
component: true

---

<ComponentPreview name="user-picker" />

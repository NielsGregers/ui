...
You can use any framework that supports React. [Next.js](https://ui.shadcn.com/shadcn/docs/installation/next), [Astro](https://ui.shadcn.com/shadcn/docs/installation/astro), [Remix](https://ui.shadcn.com/shadcn/docs/installation/remix), [Gatsby](https://ui.shadcn.com/shadcn/docs/installation/gatsby) etc.

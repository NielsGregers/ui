...
export namespace Buildings {
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Floors: item.fields.FloorsLookupId,
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Site: item.fields.SiteLookupId,
            Room: item.fields.RoomLookupId,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Sales_x0020_Order: item.fields.Sales_x0020_OrderLookupId,
    ...
    export const schema = z.object({
        ...
        Sales_x0020_Order: z.string().nullable(),
        CostCentre: z.string(),
    ...
    export function map(item: any) {
        ...
        return {
            ...
            ModifiedBy: item.lastModifiedBy.user.email,
            Modified: new Date(item.lastModifiedDateTime),
            Item: item.fields.ItemLookupId,
            DeliveryDateandTime: new Date(item.fields.DeliveryDateandTime),
            Provider: item.fields.ProviderLookupId,
            Quantity: item.fields.Quantity,
            Pricepritem: item.fields.Pricepritem,
            Catering_x0020_Order: item.fields.Catering_x0020_OrderLookupId,
            Status: item.fields.Status,
    ...
    export const schema = z.object({
        ...
        Catering_x0020_Order: z.string().nullable(),
        Status: z.string().nullable(),
        DeliverTo: z.string(),
        Room: z.string().nullable(),
        CostCentre: z.string(),
    ...
    export function map(item: any) {
        ...
        return {
            ...
            PrimaryLocation: item.fields.PrimaryLocationLookupId,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Locations: item.fields.LocationsLookupId,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Workspaces: item.fields.WorkspacesLookupId,
            Rooms: item.fields.RoomsLookupId,
            Rooms_x003a__x0020_Email: item.fields.Rooms_x003a__x0020_EmailLookupId,
            Rooms_x003a__x0020_Capacity: item.fields.Rooms_x003a__x0020_CapacityLookupId,
            ProvisioningStatus: item.fields.ProvisioningStatus,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
        ...
        Workspaces: z.string().nullable(),
        Rooms: z.string().nullable(),
        Rooms_x003a__x0020_Email: z.string().nullable(),
        Rooms_x003a__x0020_Capacity: z.string().nullable(),
        ProvisioningStatus: z.string().nullable(),
        _ColorTag: z.string(),
    })
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Comments: item.fields.Comments ? item.fields.Comments : "",
            Group: item.fields.GroupLookupId,
            Provider: item.fields.ProviderLookupId,
            Currency: item.fields.CurrencyLookupId,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Buildings: item.fields.BuildingsLookupId,
            Latitude: item.fields.Latitude ? item.fields.Latitude : "",
            Longitude: item.fields.Longitude ? item.fields.Longitude : "",
            Companiesonthislocation: item.fields.CompaniesonthislocationLookupId,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
        ...
        Buildings: z.string().nullable(),
        Latitude: z.string(),
        Longitude: z.string(),
        Companiesonthislocation: z.string().nullable(),
        _ColorTag: z.string(),
    })
    ...
    export function map(item: any) {
        ...
        return {
            ...
            ModifiedBy: item.lastModifiedBy.user.email,
            Modified: new Date(item.lastModifiedDateTime),
            Location: item.fields.LocationLookupId,
            Item_x0020_Groups: item.fields.Item_x0020_GroupsLookupId,
            Provider: item.fields.ProviderLookupId,
    ...
    export const schema = z.object({
        ...
        Item_x0020_Groups: z.string().nullable(),
        Provider: z.string().nullable(),
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Country: item.fields.CountryLookupId,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
    ...
    export function map(item: any) {
        ...
        return {
            ...
            Price_x0020_List: item.fields.Price_x0020_ListLookupId,
    ...
    export const schema = z.object({
        ...
        Price_x0020_List: z.string().nullable(),
    ...
    export function map(item: any) {
        ...
        return {
            ...
            LocationonFloor: item.fields.LocationonFloor ? item.fields.LocationonFloor : "",
            FloorMapZoom: item.fields.FloorMapZoom ? item.fields.FloorMapZoom : "",
            Desks: item.fields.DesksLookupId,
            Desks_x003a__x0020_Email: item.fields.Desks_x003a__x0020_EmailLookupId,
            Desks_x003a__x0020_Location_x002: item.fields.Desks_x003a__x0020_Location_x002LookupId,
            _ColorTag: item.fields._ColorTag ? item.fields._ColorTag : "",
        }
    }
    export const schema = z.object({
        ...
        LocationonFloor: z.string(),
        FloorMapZoom: z.string(),
        Desks: z.string().nullable(),
        Desks_x003a__x0020_Email: z.string().nullable(),
        Desks_x003a__x0020_Location_x002: z.string().nullable(),
        _ColorTag: z.string(),
    })
}
...
export interface paths {
  ...
  "/v1/rooms/sharepoint/{sharepointitemid}": {
    /**
     * Deletes a room 
     * @description Deletes a room by referencing to a sharepoint item id
     */
    delete: operations["koksmat/restapi.deleteRoom"];
  };
  "/v1/sharedmailboxes/": {
    /**
...
export interface operations {
  ...
  "koksmat/restapi.provisionRoom": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["RestapiRoomProvisionResponse"];
        };
      };
      /** @description Bad Request */
      400: {

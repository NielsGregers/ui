...
export default function Connections() {
  ...
  const path = "/Users/nielsgregersjohansen/code/koksmat/ui/apps/www/app/koksmat/[site]/kitchen/[workspace]/connect/"
  return (<div>
...
// Try to login
      <RunServerProcess caption="Login to AZ" onMessage={onAzMessage}  cmd={'az'} args={["login","--use-device-code","--allow-no-subscriptions"]} timeout={120} channelname={'az'} cwd={koksmat.currentKitchen.cwd} />
}
      ...
      {createPnpApp &&
        <RunServerProcess caption="Creating PNP application" onMessage={onMessage} cmd={'pwsh'} args={["-file", `/Users/nielsgregersjohansen/code/koksmat/ui/apps/www/app/koksmat/[site]/kitchen/[kitchen]/connect/connect-pnp.ps1`, "-tenantname",koksmat.tenant, "-applicationname",`koksmat-${koksmat.site}`]} timeout={3600} channelname={'git'} cwd={koksmat.currentKitchen.cwd} />
      }
    </div>}

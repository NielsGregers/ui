...
const cookingStations = kitchen?.stations.map(station => {return {
  ...
  items: [
   
    {
      ...
      disabled: !station,
      href: `/koksmat/${tenant}/${site}/kitchen/${workspace}/stations/${station.key}/github`,
      items: [],
    }, 
    {
      title: "Code",
      disabled: !station,
      href: `/koksmat/${tenant}/${site}/kitchen/${workspace}/stations/${station.key}/code`,
      items: [],
    },
 
    {
      title: "Build",
      disabled: true,
      href: `/koksmat/${tenant}/${site}/kitchen/${workspace}/stations/${station.key}/build`,
      items: [],
    },
    {
      title: "Ship",
      disabled: true,
      href: `/koksmat/${tenant}/${site}/kitchen/${workspace}/stations/${station.key}/ship`,
      items: [],
    },   

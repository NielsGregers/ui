...
export const roles = (tenant:string,site:string): Role[] => {return  [
  {
    ...
    link: `/koksmat/${tenant}/${site}/salesorder`,
    type: `service`,
    version: `draft`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/kitchen`,
    type: `supporting`,
    version: `draft`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/waiter`,
    type: `supporting`,
    version: `draft`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/organizer`,
    type: `core`,
    version: `draft`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/participant`,
    type: `core`,
    version: `draft`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/presenter`,
    type: `core`,
    version: `draft`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/receptionist`,
    type: `supporting`,
    version: `draft`,
  ...
  },
  {
    ...
    name: `Engineers Hand`,
    image: `/koksmat/receptionist.svg`,
    link: `/koksmat/${tenant}/${site}/role/dispatcher`,
    type: `supporting`,
    version: `preview`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/security`,
    type: `supporting`,
    version: `preview`,
  ...
  },
  {
    ...
    link: `/koksmat/${tenant}/${site}/role/technician`,
    type: `supporting`,
    version: `draft`,
  ...
  },
  {
    ...
    name: `Administrator`,
    image: `/koksmat/technician.svg`,
    link: `/koksmat/${tenant}/${site}/role/admin`,
    type: `supporting`,
    version: `preview`,

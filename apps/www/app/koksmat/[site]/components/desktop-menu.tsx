      ...
      <Menubar className="ml-3  border-0">
        ...
        <MenubarMenu>
          ...
          <MenubarContent>
            ...
            <MenubarItem>   <Link
              href={`/koksmat/${site}/kitchen`}>Open Kitchen </Link></MenubarItem>
        ...
        <MenubarMenu>
          ...
          <MenubarContent>
            ...
            <MenubarItem disabled={!kitchen}>   <Link
              href={`/koksmat/${site}/kitchen/${kitchen}/stations`}>Open Stations </Link></MenubarItem>
        ...
        <MenubarMenu>
          ...
          <MenubarContent>
            ...
            <MenubarItem>   <Link
              href={`/koksmat/${site}/kitchen`}>Open Recipies </Link></MenubarItem>
          ...
          <MenubarContent>
            <MenubarSub>
              <MenubarSub>
                ...
                <MenubarSubContent>
                  <MenubarItem >
                    <Link className="whitespace-nowrap" href={`/koksmat/${site}/azure`}>Subscriptions </Link>
                  </MenubarItem>
              ...
              <MenubarSub>
                ...
                <MenubarSubContent>
                  <MenubarItem >
                    <Link className="whitespace-nowrap" href={`/koksmat/${site}/kubernetes/clusters`}>Clusters </Link>
                  </MenubarItem>
                  <MenubarItem >
                    <Link className="whitespace-nowrap" href={`/koksmat/${site}/kubernetes/namespaces`}>Namespaces </Link>
                  </MenubarItem>
                  <MenubarItem >
                    <Link className="whitespace-nowrap" href={`/koksmat/${site}/kubernetes/pods`}>Pods </Link>
                  </MenubarItem>
                </MenubarSubContent>
              </MenubarSub>

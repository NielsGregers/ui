...
export const docsConfig  = (tenant:string,site:string,workspace:string,station:string,kitchen?:Kitchen) : DocsConfig =>  {
 const nav: DocsConfig= {
  mainNav: [
    {
      title: "Workspace",
      href: `/koksmat/${site}/kitchen/${workspace}`,
    },
    {
      title: "Components",
  ...
  sidebarNav: [
    {
      ...
      items: [
        ...
        {
          title: "Connect",
          href: `/koksmat/${site}/kitchen/${workspace}/connect`,
          items: [],
        },
...
const cookingStations = kitchen?.stations.map(station => {return {
  ...
  items: [
   
    {
      ...
      disabled: !station,
      href: `/koksmat/${site}/kitchen/${workspace}/stations/${station.key}/github`,
      items: [],
    }, 
    {
      title: "Code",
      disabled: !station,
      href: `/koksmat/${site}/kitchen/${workspace}/stations/${station.key}/code`,
      items: [],
    },
 
    {
      title: "Build",
      disabled: true,
      href: `/koksmat/${site}/kitchen/${workspace}/stations/${station.key}/build`,
      items: [],
    },
    {
      title: "Ship",
      disabled: true,
      href: `/koksmat/${site}/kitchen/${workspace}/stations/${station.key}/ship`,
      items: [],
    },   

...
export default function CardsPage() {
  return (
    <>
      ...
      <div className="hidden items-start justify-center gap-6 rounded-lg p-8 md:grid xl:grid-cols-3 lg:grid-cols-2">
        ...
        <div className="col-span-2 grid items-start gap-6 xl:grid-cols-1 lg:col-span-1 lg:grid-cols-2">
          <DemoContainer>
            <DemoReportAnIssue />
          </DemoContainer>
          <DemoContainer>

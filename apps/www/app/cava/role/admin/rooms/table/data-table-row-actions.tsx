    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-[160px]">
        ...
        {room.provisioningstatus === "Provision" &&
          <DropdownMenuItem onClick={()=>usecases.ProvisionRoom(room.id)} className="cursor-pointer">
           Provision 
           
          </DropdownMenuItem>
        }     
        {(room.provisioningstatus === "Delete" || room.provisioningstatus === "Provisioned") &&
          <DropdownMenuItem onClick={()=>usecases.DeleteRoom(room.id)} className="cursor-pointer">
            Delete

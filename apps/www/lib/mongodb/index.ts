...
export function connect(): Promise<mongoDB.MongoClient> {
  return new Promise(async (resolve, reject) => {
    ...
    var client: mongoDB.MongoClient = new mongoDB.MongoClient(
      connectionString,
      options
    )
    client
...
export function connectBooking(): Promise<mongoDB.MongoClient> {
  return new Promise(async (resolve, reject) => {
    var options: mongoDB.MongoClientOptions = {}

    var connectionString = process.env.MONGODBBOOKING as string
